...
class Graficos extends Database {
    ...
    public function visualizar_usuarios_escolaridade_bairro(string $escolaridade, string $bairro){
    ...
    public function visualizar_usuarios_escolaridade_cidade(string $escolaridade, string $cidade){
    ...
    public function visualizar_usuarios_escolaridade_escola(string $escolaridade, int $escola_id){
    ...
    public function visualizar_usuarios_escolaridade_genero(string $escolaridade, string $genero){
